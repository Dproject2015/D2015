if( document.createElement('svg').getAttributeNS ) {
	...
	var checkbxsCross = Array.prototype.slice.call( document.querySelectorAll( 'form.ac-cross input[type="checkbox"]' ) ),
		...
		radiobxCheckmark = Array.prototype.slice.call(document.querySelectorAll('form.ac-checkmark input[type="radio"]')),
		pathDefs = {
	...
	radiobxCheckmark.forEach( function( el, i ){ controlRadiobox( el, 'checkmark' ); } );
